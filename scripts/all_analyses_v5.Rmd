...
Nice. Now let's do the same for the `quotative_verb` category. First, calculate the % Y/N for each word.
...
Now let's calculate the iconic gesture rates for each word by category. First, define a function called `calc_word_iconic`.
